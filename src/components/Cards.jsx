...
const Cards = () => {
    return (
        <div className='py-10 px-4 md:px-20 flex flex-wrap lg:flex-nowrap gap-4'>
            <div className="w-full col-span-1 bg-[#004D43] flex items-center justify-center h-96 rounded-xl relative">
            ...
            <div className="w-full flex flex-col gap-4 sm:flex-row">
                <div className="w-full col-span-1 bg-[#212121] flex items-center justify-center h-96 rounded-xl relative">
